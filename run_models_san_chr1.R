source("san_models.R")
out.file.name <- "/home/yolandi01/LAAA_model/analysis/output/LAAA_san_chr1.txt"
pheno.frame <- read.delim("/home/yolandi01/LAAA_model/Phenotype.txt", stringsAsFactors = F)
allele.frame <- read.delim("/home/yolandi01/LAAA_model/analysis/inputfiles_for_laaamodel/san/chr1_allele_dose.txt", stringsAsFactors = F)
san.frame <- read.delim("/home/yolandi01/LAAA_model/analysis/inputfiles_for_laaamodel/san/chr1_san_dose.txt", stringsAsFactors = F)
allele.san.frame <- read.delim("/home/yolandi01/LAAA_model/analysis/inputfiles_for_laaamodel/san/chr1_allele_san_dose.txt", stringsAsFactors = F)
cat("position\tref\talt\talt_frq\tunadj_allele_dose_beta\tunadj_allele_dose_beta_se\tunadj_allele_dose_p\tallele_dose_beta\tallele_dose_beta_se\tallele_dose_p\tsan_dose_beta\tsan_dose_beta_se\tsan_dose_p\tallele_san_dose_beta\tallele_san_dose_beta_se\tallele_san_dose_p\tanova_p\n", sep="", file=out.file.name, append=F)
